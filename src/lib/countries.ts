// Libellés FR des codes pays — extraits des commentaires de l'enum `countryCode_enum` (Hasura).
...
export const countryLabel = (code?: string | null) =>
  (code && COUNTRY_LABELS[code]) || code || "N.C.";

export const continentLabel = (code?: string | null) =>
  (code && CONTINENT_LABELS[code]) || code || "N.C.";
